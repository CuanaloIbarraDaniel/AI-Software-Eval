...
### Requisitos
- VueJS 3.2.X CLI Instalado
- Net Core 5.0 SDK Instalado
...
Se tendrán que ejecutar las pruebas de Postman debido a que estas también se encargan de inicializar la base de datos con información para el resto de la aplicación.
